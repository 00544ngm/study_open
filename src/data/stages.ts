...
export const stages: Stage[] = [
  {
    ...
    title: "基础层",
    subtitle: "Foundation",
    description: "AI Agent 开发的基石。Python、Git、Linux、FFmpeg、Pytest、React 是必须掌握的实用技能。",
    color: "from-blue-500 to-cyan-500",
    topics: [
      { id: "python", title: "Python", order: 1 },
      { id: "git", title: "Git", order: 2 },
      { id: "windows", title: "Windows", order: 3 },
      { id: "linux", title: "Linux", order: 4 },
      { id: "system-setup", title: "系统安装", order: 5 },
      { id: "ffmpeg", title: "FFmpeg", order: 6 },
      { id: "pytest", title: "Pytest 测试", order: 7 },
      { id: "react", title: "React 基础", order: 8 },
    ],
  },
  {
    id: "02-backend",
